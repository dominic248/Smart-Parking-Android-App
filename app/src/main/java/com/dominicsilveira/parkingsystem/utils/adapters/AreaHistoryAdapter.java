...
public class AreaHistoryAdapter extends RecyclerView.Adapter<AreaHistoryAdapter.MyViewHolder>{

    List<BookedSlots> bookedSlotsList = new ArrayList<BookedSlots>();
    FirebaseAuth auth;
    FirebaseDatabase db;

    public AreaHistoryAdapter(List<BookedSlots> bookedSlotsList){
    ...
    @Override
    public AreaHistoryAdapter.MyViewHolder onCreateViewHolder(ViewGroup parent,
                                                              int viewType) {
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.user_history_row_layout, parent, false);
        AreaHistoryAdapter.MyViewHolder pvh = new AreaHistoryAdapter.MyViewHolder(v);
        return pvh;
    }

    // Replace the contents of a view (invoked by the layout manager)
    @Override
    public void onBindViewHolder(final AreaHistoryAdapter.MyViewHolder holder, int position) {
...
//        final ParkingArea parkingArea = (ParkingArea) closestDistance.parkingArea;
    ...
    public void setDatas(AreaHistoryAdapter.MyViewHolder holder, final BookedSlots bookedSlot){
